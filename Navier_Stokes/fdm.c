...
matrix *fdm_1(int n, int o, double dx)
{
    int i;
    matrix *D = init_matrix(n, n);

    if (o == 2) // second order
    {
        //Forward difference coefficients bcs no cells on left and use first order as not enough points
        D->M[0][0] = -1. / dx;
        D->M[0][1] = 1. / dx;
        for (i = 1; i < (n - 1); i++)
        {
    ...
    else if (o == 4) // Fourth-order
    {
        ...
        D->M[0][0] = (double)-1 / dx;
        D->M[0][1] = (double)1 / dx;
        //Forward difference coefficients use second order as not enough points
        D->M[1][0] = (double)-0.5 / dx;
        D->M[1][1] = (double)0 / dx;
        D->M[1][2] = (double)0.5 / dx;
        //Central difference fourth order coeffs
        for (i = 2; i < (n - 2); i++)
        {
...
matrix *fdm_2(int n, int o, double dx)
{
    int i;
    matrix *D = init_matrix(n, n);
