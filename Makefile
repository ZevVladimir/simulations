...
nav_stoke:
	gcc -g -I. -o nav_stoke Navier_Stokes/main.c Navier_Stokes/linalg.c Navier_Stokes/fdm.c Navier_Stokes/fluiddyn.c Navier_Stokes/poisson_slvr.c Navier_Stokes/utils.c Navier_Stokes/setups.c -lm

clean:
	rm -f *.o nbody_sim hydro_sim nav_stoke